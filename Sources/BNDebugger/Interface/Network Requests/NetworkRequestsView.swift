...
struct NetworkRequestsView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .searchable(text: $searchText, prompt: "Search requests, URLs, or methods")
            .toolbar {
            ...
            .alert("Clear Network Requests", isPresented: $showingClearAlert) {
                Button("Cancel", role: .cancel) { }
                Button("Clear", role: .destructive) {
                    viewModel.clearRequests()
                }
            } message: {
                Text("Are you sure you want to clear all network requests?")
            }
        }
    }
